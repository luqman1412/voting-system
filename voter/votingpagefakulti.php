...
// get voter id & voter faculty  from session
$voterid=$_SESSION['id'];
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
                <div class="p-5">
                  ...
                  <!-- form start -->
                  <form name="form_fakulti" method="POST" action="">
                    <table class="table ">
                      <thead>
                        <h2>calon fakulti</h2>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="form-check">
                            <input name="fakulti_candidate_selected" class="form-check-input" type="checkbox" value="" >
                          </div>
                        </td>
                      </tr>
                      <?php
