            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                    ...
                    if (isset($_GET['error'])) {
                      if ($_GET['error'] == "emptyfield") {
                        ...
                        if ($_GET['success']=="checkemail") {
                          ...
                          successwithclose("You password has been change, Please login using your new password");
                        }
                    }
                   ?>
                  <form name="login_form" class="user" method="POST" action="validateuser.php">
                    <div class="form-group">
                      <input name="txt_username" type="text" class="form-control form-control-user" id="matric_no" aria-describedby="matric_no" placeholder="Enter Matric number...">
                    </div>
                    <div class="form-group">
                      <input name="txt_password" type="password" class="form-control form-control-user" id="password" placeholder="Password">
                    </div>
                  ...
                  <div class="text-center">
                    <a class="small" href="register/">Register as Voter!</a>
                  </div>
                </div>
              </div>
            </div>
